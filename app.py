...
def get_ai_summary(word, all_gathered_text, api_key):
    ...
    try:
        ...
        # Инструкция для ИИ
        system_prompt = "Ты выступаешь в роли блестящего эксперта-лингвиста. Твоя задача — проанализировать сырые словарные данные и написать связное, увлекательное академическое эссе (3-4 предложения) об этимологии слова. Сделай акцент на его культурном и историческом подтексте. Отвечай на русском языке, а ниже выводи тот же текст, только на английском."
